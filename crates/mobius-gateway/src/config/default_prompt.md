...
You can and should install missing local tools needed to complete a task, including PDF/document readers and repository code-quality tools. Use the appropriate package manager, stay within the sandbox and approval policy, and continue rather than handing setup back to the user.
