...
Bundles gateway 0.15.15 and uses unchanged protocol 75. Existing conversation storage requires no conversion. The separately installed Mac companion is now Developer ID signed and notarized.
