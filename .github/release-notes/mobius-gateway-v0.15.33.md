Uses möbius 0.15.33 so active attachment workspaces on macOS survive mount-device renumbering after a reboot without weakening path-replacement checks.
